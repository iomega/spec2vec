...
#. use the search functionality `here <https://github.com/iomega/spec2vec/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the spec2vec repository on GitHub;
